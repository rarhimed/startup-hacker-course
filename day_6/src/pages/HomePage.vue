  ...
  <div class="home-page">
    ...
    <div class="controls">
      <div class="controls-left">
        <SButton color="green" @click="openAddForm">
          Добавить
        </SButton>
        <SButton color="yellow" @click="resetAllRatings">
    ...
    <!-- Форма - используем SDialog из startup-ui -->
    <SDialog
      v-model="showForm"
      :title="formTitle"
      width="500px"
...
/* Кастомная кнопка "О нас" - синий цвет (гармонирует с зелёным и жёлтым) */
.about-button {
